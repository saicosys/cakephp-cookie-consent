 ...
 * @since     1.0.0
 */
namespace Saicosys\CookieConsent\Test\TestCase\Middleware;

use Cake\TestSuite\TestCase;
use Saicosys\CookieConsent\Middleware\CookieConsentMiddleware;

/**
 * Saicosys\CookieConsent\Middleware\CookieConsentMiddleware Test Case
 */
class CookieConsentMiddlewareTest extends TestCase
{
     ...
     * Test subject
     *
     * @var \Saicosys\CookieConsent\Middleware\CookieConsentMiddleware
     */
